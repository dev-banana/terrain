...
void main( )
{
    background_color = vec4( abs(default_color.r-1.f), abs(default_color.g-1.f), abs(default_color.b-1.f), 1 ) ;
    ...
    vec4 back_color= texelFetch(font, back_uv, 0) * background_color;
